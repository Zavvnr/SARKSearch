...
class Settings:
    def __init__(self, environ: Mapping[str, str] | None = None) -> None:
        ...
        self.default_search_limit = _get_int("DEFAULT_SEARCH_LIMIT", 5, environ=source)
        self.max_search_limit = _get_int("MAX_SEARCH_LIMIT", 20, self.default_search_limit, source)
