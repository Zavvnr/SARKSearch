...
- GPT-backed behavior is optional and fails safely to heuristic mode

## Quality checks

- Python unit tests cover ranking and PDF generation
...
- Add connector APIs or ingestion jobs for live catalog updates
- Add richer behavioral analytics
- Add stronger PDF visual regression checks if branding expands
- Add integration tests for GPT-backed mode when API credentials are available
